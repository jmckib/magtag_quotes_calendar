...
def main():
	...
	# ----------------------------
	BMP_PATH = "/images/weather/"
	BACKGROUND_BMP = BMP_PATH + "weather_bg.bmp"
	ICONS_LARGE_FILE = BMP_PATH + "weather_icons_70px.bmp"
	ICONS_SMALL_FILE = BMP_PATH + "weather_icons_20px.bmp"
	...
	# Do this now so quote loads faster when it's called for.
